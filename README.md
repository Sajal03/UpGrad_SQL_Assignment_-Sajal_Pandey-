# UpGrad_SQL_Assignment_-Sajal_Pandey-
 Basics of Data science(Stock Market Project)
...
Moving Average As you can see, Moving average use the past data to smoothen the price curve. For the purpose of this assignment, we will be using 20 Day and 50 Day moving averages.
